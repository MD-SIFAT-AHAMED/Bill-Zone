    ...
    <div className="max-w-3xl mx-auto p-4">
      <div className="card card-side bg-base-100 shadow-lg hover:border-orange-400 hover:border transition-transform transform duration-200 hover:scale-105">
        ...
        <div className="card-body ">
          {bill.paid && (
            <p className="w-fit text-white px-3 py-1 rounded-2xl bg-green-400">
              Already Paid
            </p>
          )}
          ...
          <div className="card-actions mt-2">
            <Link to={`/details/${bill.id}`} className="w-full">
              <button className="btn text-white hover:bg-white hover:border hover:border-orange-400 hover:text-black w-full bg-orange-400 rounded-2xl btn-sm">
                Pay
              </button>
            </Link>
          </div>
