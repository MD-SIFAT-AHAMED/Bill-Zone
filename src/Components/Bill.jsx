      ...
      <div className="card-body">
        ...
        <div className="card-actions mt-2">
          <Link to={`/details/${bill.id}`} className="w-full">
            <button className="btn text-white hover:bg-white hover:border hover:border-orange-400 hover:text-black w-full bg-orange-400 rounded-2xl btn-sm">Details</button>
          </Link>
        </div>
      </div>
    </div>
